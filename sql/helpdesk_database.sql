...
('2020s17982', 'When will the PH2003 physics practical sessions be scheduled for this semester?', 'Department of Physics', 'completed'),
('2020s18073', 'Query about plant taxonomy field trip for BS1005 course requirements.', 'Department of Plant Sciences', 'completed'),
('2021s18545', 'Clarification needed on statistical software training for ST2002 workshop.', 'Department of Statistics', 'completed'),
('2021s18623', 'Inquiry about environmental science research project guidelines for ZO3005.', 'Department of Zoology and Environment Sciences', 'completed'),
('2021s18646', 'Unable to access online learning portal credentials reset request.', 'IT Services Centre (ITSC)', 'completed'),
('2021s18660', 'Need career guidance session appointment for postgraduate opportunities.', 'Career Guidance Unit (CGU)', 'completed'),
('2021s18697', 'How to access rare science journals through library digital resources?', 'Science Library', 'completed'),
